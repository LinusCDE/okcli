...
### Thanks
Thanks to [mycli](https://github.com/dbcli/mycli). Most of the features (eg. syntax highlighting, auto-complete) were implemented by the mycli core team for MySQL.
